...
$sql = "SELECT * from crypto where cid=4";
...
<header>
    ...
    <main>
        ...
        <div class="coin-about">
            ...
            <p>Dogecoin (DOGE) is an open-source, peer-to-peer cryptocurrency that was made as a parody of the crypto market following the establishment of Bitcoin. It was originally created as a light-hearted joke for crypto enthusiasts, but it quickly exploded to be one of the leading cryptocurrencies in use today. The main purpose of its creation was to raise public awareness of blockchain technology capabilities.</p>
        </div>
    </main>
