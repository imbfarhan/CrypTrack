...
$sql = "SELECT * from crypto where cid=1";
...
<header>
    ...
    <main>
        ...
        <div class="coin-about">
            ...
            <p>Bitcoin is the first cryptocurrency that was launched in 2009 by a person or a group of people that went by the name of Satoshi Nakamoto. It was first described in the whitepaper known as Bitcoin: A Peer to Peer Electronic Cash System that detailed exactly how it would work. It is currently available in many crypto markets and has a high market cap.</p>
        </div>
    </main>
