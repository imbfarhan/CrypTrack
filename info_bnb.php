...
$sql = "SELECT * from crypto where cid=3";
...
<header>
    ...
    <main>
        ...
        <div class="coin-about">
            <h4>What is BNB?</h4>
            <p>Binance Coin(BNB) is the cryptocurrency issued by the Binance exchange and trades with the BNB symbol. BNB was initially based on the Ethereum network but is now the native currency of Binance's own blockchain, the Binance chain. Every quarter, Binance uses one-fifth of its profits to repurchase and permanently destroy, or "burn," Binance coins held in its treasury.</p>
        </div>
    </main>
